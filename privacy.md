---
title: Six-Letter Word Puzzle - Privacy Policy
layout: default
...
<h1>Privacy Policy for Six-Letter Word Puzzle</h1>

<p>Six-Letter Word Puzzle is a simple game application that collects no identifiable user information.</p>
...
<p>Six-Letter Word Puzzle may produce log files locally, on the device that it runs on.  No log files are transmitted to an external server or any other device.</p>
...
<p>Six-Letter Word Puzzle does not knowingly collect any Personal Identifiable Information from children under the age of 13.</p>


<h2>Request User Data Deletion</h2>

<p>When you install and use Six-Letter Word Puzzle mobile application, some of your data may be collected and processed for different legitimate purposes.</p>

<p>You will find below explanations regarding the reasons why your data may be collected.</p>

<h3>Why is data collected?</h3>

<p>Six-Letter Word Puzzle application's third-party partners may collect data:</p>
...
<p>The third-party partners of Six-Letter Word Puzzle that may collect data are:</p>
...
<p>By using Six-Letter Word Puzzle application, you hereby consent to our Privacy Policy and agree to its terms.</p>
